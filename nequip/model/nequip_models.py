...
def FullNequIPGNNCSOModel(
    ...
    # == edge tensor embedding ==
    spharm = SphericalHarmonicEdgeAttrs(
        irreps_edge_sh=irreps_edge_sh, irreps_in=type_embed.irreps_out, r_mid=r_mid,
    )
    # == edge scalar embedding ==
    edge_norm = EdgeLengthNormalizer(
        r_max=r_max,
